...
export default function MyModal({ setPlay }) {
                ...
                <Dialog.Panel className='w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all'>
                  ...
                  <div className='mt-2'>
                    <p className='text-sm text-gray-500'>
                      Test your memory, start by flipping a card. Then try to
                      find the matching card. Each incorrect guess bring your
                      score down, so choose wisely.
                    </p>
                  </div>
                  <div className='mt-4'>
                    <button
